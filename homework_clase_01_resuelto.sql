...
LINES TERMINATED BY '\n' 
IGNORE 1 ROWS
(@col1, @col2) --  Solo usa columna 1 y 2 debido a que el resto eran nulas
SET IdCanal = @col1, Canal = @col2; -- setea los valores de las columnas 1 y 2  a id canal y canal respectivamente.
